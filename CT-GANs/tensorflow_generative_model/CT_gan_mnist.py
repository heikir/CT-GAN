...
MODE = 'wgan-CT' # dcgan, wgan, or wgan-gp
...
if MODE == 'wgan':
    ...
    #disc_cost += 0.05*tf.losses.mean_squared_error(disc_fake, disc_fake_2)
    #disc_cost += 0.5*tf.losses.mean_squared_error(disc_fake_, disc_fake_2_)
...
# Dataset iterator
train_gen, dev_gen, test_gen = lib.mnist.load(BATCH_SIZE, BATCH_SIZE,n_examples)
def inf_train_gen():
    while True:
